...
import hirolaNavbarTag from "../../Images/HirolaNavbarTag.jpeg"
                ...
                <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
                    ...
                    <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                        <nav>
                            <ul className="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                                <li>
                                    <NavLink className="inline-block no-underline hover:text-black  hover:bg-red-200 rounded-full py-2 px-4 hover-transition" exact to="/">Home</NavLink>
                                </li>
                                <li>
                                    <NavLink
                                        className="inline-block no-underline hover:text-black py-2 px-4 hover:bg-red-200 rounded-full hover-transition"
                                        exact to="/about"
                                    >About</NavLink>
                                </li>
                            </ul>
                    ...
                    <div className="order-1 md:order-2">
                        <NavLink
                            ...
                            exact to="/"
                        >
                            <img src={hirolaNavbarTag} alt="Hirola" />
                        </NavLink>
                    </div>
